...
8. [docs/CODE_DEEP_DIVE.md](docs/CODE_DEEP_DIVE.md) - function-level intent and deeper reasons
9. [docs/C_LANGUAGE_PRIMER.md](docs/C_LANGUAGE_PRIMER.md) - C and FreeRTOS fundamentals in this repo
