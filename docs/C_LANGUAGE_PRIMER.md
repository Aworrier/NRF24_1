...
- English: Read this after [docs/CODE_WALKTHROUGH.md](docs/CODE_WALKTHROUGH.md). It explains the C and FreeRTOS ideas used in the code.
- 中文：建议先读 [docs/CODE_WALKTHROUGH.md](docs/CODE_WALKTHROUGH.md)，再读本页了解代码中用到的 C/FreeRTOS 原理。
